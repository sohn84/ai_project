      ...
      <div className="fixed inset-0 z-50 flex items-end">
        ...
        >
          ...
          <div className="px-5 pt-4 pb-3 bg-[#f9f9f9]">
            <p className="text-[14px] text-[#666] mb-1">ìì</p>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right ml-3">
                    ...
                    <p className="text-[12px] text-[#999]">ì¶ê° ìê¸</p>
                  </div>
                </div>
                ...
                {selectedRoomType?.id === room.id && (
                  <div className="mt-3 flex items-center text-[#7b3ff2]">
                    ...
                    <span className="text-[13px] font-['Pretendard:SemiBold',sans-serif]">ì íë¨</span>
                  </div>
                )}
              </button>
            ))}
          ...
          <div className="sticky bottom-0 bg-white border-t border-[#f0f0f0] px-5 py-4">
            ...
            >
              {selectedRoomType ? `${selectedRoomType.name} ì í ìë£` : "ë£¸íìì ì íí´ì£¼ì¸ì"}
            </button>
          </div>
        </motion.div>
      </div>
