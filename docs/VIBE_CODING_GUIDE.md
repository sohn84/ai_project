...
3.  **목업 제작**: UI/UX 시각화
    - **옵션 A**: Figma Make (AI 프로토타입 생성) ← 권장
    - **옵션 B**: HTML/CSS 수동 프로토타입
    - **옵션 C**: 와이어프레임 문서 (MOCKUP.md)
...
### Figma Make → 코드 변환 워크플로우

1. **Figma Make에서 프로토타입 생성**
   - 프롬프트로 UI 컴포넌트 생성
   - 반응형 레이아웃 설정
...
## 4. MCP(Model Context Protocol) 연동 규칙
