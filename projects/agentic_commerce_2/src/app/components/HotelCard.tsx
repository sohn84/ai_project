    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] text-[#7b3ff2] font-['Pretendard:SemiBold',sans-serif]">추천 숙소</span>
        </div>
      </div>
      ...
      <div className="bg-[#f8f9fa] rounded-[12px] p-3 mb-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-[13px] text-[#666] font-['Pretendard:SemiBold',sans-serif]">숙소</span>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <span className="text-[11px] text-[#999] mr-1">{hotel.passengerCount}인 기준</span>
